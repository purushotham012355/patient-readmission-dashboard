...
<style>
    ...
    * { font-family: 'Syne', sans-serif; }
    ...
    .main-header {
        ...
        padding: 2.5rem;
        margin-bottom: 2rem;
        box-shadow: 0 0 60px rgba(45,106,159,0.2);
    }
    .risk-high {
        ...
        <div style="display:flex; justify-content:space-between; align-items:center;">
            <div>
                ...
                <p style="margin:0.5rem 0 0 0; color:#718096; font-size:0.95rem;">
                    AI-powered 30-day readmission prediction - 101,766 patient dataset
                </p>
            </div>
...
Keep it professional and actionable."""
            ...
            <div class="care-plan-box">
                {care_plan_text.replace(chr(10), '<br>')}
            </div>
            """, unsafe_allow_html=True)
        ...
        def generate_pdf(patient_age, days, meds, admissions, emergency,
                         diagnoses, labs, risk_score, risk_tier, care_plan):
            buffer = io.BytesIO()
            ...
            if 'HIGH' in risk_tier:
                rc = colors.HexColor('#ff4444')
            elif 'MEDIUM' in risk_tier:
                rc = colors.HexColor('#ff9944')
            else:
                rc = colors.HexColor('#44cc88')

            story.append(Paragraph(f"{risk_score}%",
                ParagraphStyle('risk', fontSize=32, fontName='Helvetica-Bold',
                               textColor=rc, alignment=TA_CENTER, spaceAfter=4)))
            story.append(Paragraph(risk_tier,
                ParagraphStyle('tier', fontSize=14, fontName='Helvetica-Bold',
                               textColor=rc, alignment=TA_CENTER, spaceAfter=20)))
            ...
            story.append(Paragraph(
                "This report is generated by an AI system for clinical decision support only. "
